...
# 1. Antidote (plugin manager) - load plugins from $ZDOTDIR/.zsh_plugins.txt
...
# 2. Source every *.zsh in $ZDOTDIR (= ~/.config/zsh/)
...
# 3. Starship prompt - last so it wins over any plugin prompt
